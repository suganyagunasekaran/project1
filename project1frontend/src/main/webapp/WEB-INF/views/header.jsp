	...
	<div class="container-fluid" >
		<nav class="navbar navbar-default" id="nav_bar" >
			<div class="navbar-header">
				<a href="resources/images/logo.png" class="navbar-brand"><img class="img-circle" src="<c:url value='/resources/images/lodo.png'></c:url>" alt="img" height="50px" width="50px"></a>
